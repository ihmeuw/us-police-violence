...
def scatter_incarceration_police_violence(scatter_type, v_type):
    ...
    incar = add_population(
        incar, force_rerun=True, block_rerun=False, pop_run_id=CONF.get_id("pop_run"),
        decomp_step=CONF.get_id("decomp_step"), gbd_round_id=CONF.get_id("gbd_round"))
    report_if_merge_fail(incar, 'population', 'location_id')
    if v_type == "five":
        incar["year_id"] = incar["year_id"].map({
                        1980: "1980-1984", 1981: "1980-1984", 1982: "1980-1984",
                        1983: "1980-1984", 1984: "1980-1984", 1985: "1985-1989",
                        1986: "1985-1989", 1987: "1985-1989", 1988: "1985-1989",
                        1989: "1985-1989", 1990: "1990-1994", 1991: "1990-1994",
                        1992: "1990-1994", 1993: "1990-1994", 1994: "1990-1994",
                        1995: "1995-1999", 1996: "1995-1999", 1997: "1995-1999",
                        1998: "1995-1999", 1999: "1995-1999", 2000: "2000-2004",
                        2001: "2000-2004", 2002: "2000-2004", 2003: "2000-2004",
                        2004: "2000-2004", 2005: "2005-2009", 2006: "2005-2009",
                        2007: "2005-2009", 2008: "2005-2009", 2009: "2005-2009",
                        2010: "2010-2014", 2011: "2010-2014", 2012: "2010-2014",
                        2013: "2010-2014", 2014: "2010-2014", 2015: "2015-2019",
                        2016: "2015-2019", 2017: "2015-2019", 2018: "2015-2019",
                        2019: "2015-2019", 2020: "2020-2024"  })
        incar = incar.groupby(["location_id", "year_id", "re", "state_id", "sex_id",
                               "age_group_id"]).agg({"population": "sum", "prisoners": "sum"}).reset_index()
    if v_type == "ten":
        incar["year_id"] = incar["year_id"].map({
                        1980: "1980-1989", 1981: "1980-1989", 1982: "1980-1989",
                        1983: "1980-1989", 1984: "1980-1989", 1985: "1980-1989",
                        1986: "1980-1989", 1987: "1980-1989", 1988: "1980-1989",
                        1989: "1980-1989", 1990: "1990-1999", 1991: "1990-1999",
                        1992: "1990-1999", 1993: "1990-1999", 1994: "1990-1999",
                        1995: "1990-1999", 1996: "1990-1999", 1997: "1990-1999",
                        1998: "1990-1999", 1999: "1990-1999", 2000: "2000-2009",
                        2001: "2000-2009", 2002: "2000-2009", 2003: "2000-2009",
                        2004: "2000-2009", 2005: "2000-2009", 2006: "2000-2009",
                        2007: "2000-2009", 2008: "2000-2009", 2009: "2000-2009",
                        2010: "2010-2019", 2011: "2010-2019", 2012: "2010-2019",
                        2013: "2010-2019", 2014: "2010-2019", 2015: "2010-2019",
                        2016: "2010-2019", 2017: "2010-2019", 2018: "2010-2019",
                        2019: "2010-2019", 2020: "2020-2029"  })
        incar = incar.groupby(["location_id", "year_id", "re", "state_id", "sex_id",
                               "age_group_id"]).agg({"population": "sum", "prisoners": "sum"}).reset_index()
    ...
    pv = pv.groupby(["location_id", "year_id"])["gpr_mean"].sum().reset_index()
    pv["sex_id"] = 3
    pv["age_group_id"] = 22
    pv = add_population(
        pv, force_rerun=True, block_rerun=False, pop_run_id=CONF.get_id("pop_run"),
        decomp_step=CONF.get_id("decomp_step"), gbd_round_id=CONF.get_id("gbd_round"))
    report_if_merge_fail(pv, 'population', 'location_id')

    if v_type == "five":
        pv["year_id"] = pv["year_id"].map({
                        1980: "1980-1984", 1981: "1980-1984", 1982: "1980-1984",
                        1983: "1980-1984", 1984: "1980-1984", 1985: "1985-1989",
                        1986: "1985-1989", 1987: "1985-1989", 1988: "1985-1989",
                        1989: "1985-1989", 1990: "1990-1994", 1991: "1990-1994",
                        ...
                        2016: "2015-2019", 2017: "2015-2019", 2018: "2015-2019",
                        2019: "2015-2019", 2020: "2020-2024"  })
        pv = pv.groupby(["location_id", "year_id", "sex_id",
                              "age_group_id"]).agg({"population": "sum", "gpr_mean": "sum"}).reset_index()
    if v_type == "ten":
        pv["year_id"] = pv["year_id"].map({
                        1980: "1980-1989", 1981: "1980-1989", 1982: "1980-1989",
                        1983: "1980-1989", 1984: "1980-1989", 1985: "1980-1989",
...
if __name__ == '__main__':
    ...
    with pd.ExcelWriter('FILEPATH') as writer:
        print(writer)
        for v_type in (["one", "five", "ten"]):
            df = scatter_incarceration_police_violence('state', v_type)
            df.to_excel(writer, sheet_name=v_type)
